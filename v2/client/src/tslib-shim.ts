...
export function __generator(thisArg: any, body: any) {
    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g: any;
    return g = { next: verb(0), "throw": verb(1), "return": verb(2) }, typeof Symbol === "function" && (g[Symbol.iterator] = function() { return this; }), g;
    function verb(n: number) { return function (v: any) { return step([n, v]); }; }
...
export function __rest(s: any, e: any) {
    ...
    if (s != null && typeof (Object as any).getOwnPropertySymbols === "function")
        for (var i = 0, p = (Object as any).getOwnPropertySymbols(s); i < p.length; i++) {
            if (e.indexOf(p[i]) < 0 && (Object as any).prototype.propertyIsEnumerable.call(s, p[i]))
                t[p[i]] = s[p[i]];
        }
    return t;
}
